...
const references = [
  ...
  /*{
    ...
    message2:
      "I met John in 2019, December, when he was placed under my supervision as a research intern. I came to know him as an impressive problem solver who is able to address complex issues strategically and confidently. He was a truely valuable asset to our research team and his quiz software is greatly useful even today in IIT Bombay. ",
    ...
    message1:
      "John has shown great interest in handling our projects. He is extremely hard-working, honest and dependable. Beyond that, he is an impressive problem solver",
    ...
    message2:
      "John has been a fantastic judge to the hackathon. Very hardworking, smart, and always a learner!",
  },

  {
    ...
    message1:
      "As John's co-jugde in the Elevate Tech Hackathon, I must say he is an inspiration to thousands. A great learner and a teacher too.",
    ...
    message2:
      "John was my co-mentor for AtlasHacks in 2020. It was a pleasure to work with him, a true learner and extremely creative.",
  },
...

  {
    ...
    image2: "assets/images/references-page/reviewphoto2.png",
    message2:
      "John did an excellent job in staying up to date on software developments and thus finding new solutions. He had the most extensive and diverse knowledge of software at our company, and others even sought him out for advice. A reliable and highly capable employee.",
  },
  {
    sl1: 1,
