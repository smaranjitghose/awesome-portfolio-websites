...
const showCards = () => {
  let output = "";
  projects.forEach(
    ({ title, cardImage, tag, tagimg="", Previewlink, Githublink }) =>
      (output += `       
      ...
      <div class="wrapper" style="background: url(${cardImage}) center / cover no-repeat;">
        ...
        <div class="data">
          ...
          <div class="title-div">
            ...
            <div class="searchdiv"><button class="tagbutton"><img class="tagbutton tagimg" width="40px" src=${tagimg} alt="" />${tag}</button></div>
