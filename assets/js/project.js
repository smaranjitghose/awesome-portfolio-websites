...
const showCards = () => {
  let output = "";
  projects.forEach(
    ({ title, description, cardImage, tags, Previewlink, Githublink }) => {
      (output += `       
        <div class="column skill-card card" style="margin: 15px"data-aos="zoom-in-up" data-aos-easing="linear" data-aos-delay="300" data-aos-duration="600" >
          <div class="wrapper" style="background: url(${cardImage}) center / cover no-repeat;">
            ...
            <div class="data" style="overflow: auto;text-align:justify;">
              <div class="content">
              <div class="title-div" >
                <h1 class="title" style="max-width:90%"><a href="#">${title}</a></h1>
