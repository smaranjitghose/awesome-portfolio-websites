    ...
    <div className="home">
      ...
      <div className="desc">
        <div className="desc-1">
          <span className="text">
            Hi <img className="wave" src={Hand} alt="" />, I'm{" "}
            <span>
              {" "}
              <b> John Doe</b>
            </span>
        ...
        <div class="social-icons">
          ...
          <a
            class="socialicon codeforces"
            href="https://codeforces.com/"
            target="_blank"
            rel="noreferrer"
          >
            <svg
              class="codeforces-icon"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="5 0 14 19"
              width="100"
              height="100"
