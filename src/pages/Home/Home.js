            ...
            <div className="desc">
                ...
                <div className='typing'>
                    <ReactTypingEffect
                        ...
                        staticText="I'm into"
                        text={[" Designing", " UI/UX", " Cloud Computing", " Web Development", " Open Source", " Mentoring"]}
                        speed={50}
                        eraseSpeed={50}
                        typingDelay={50}
                        eraseDelay={150}
                ...
                <div class="social-icons">
                    <a class="socialicon twitter" href="https://twitter.com" target="_blank" rel="noreferrer">
                        <svg class="twitter-icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" enableBackground="new 0 0 500 500" xmlSpace="preserve">
                    ...
                    <a class="socialicon medium" href="https://medium.com/" target="_blank" rel="noreferrer" >
                        <FontAwesomeIcon icon={faMediumM} className='icons' />
                    </a>
                    <a class="socialicon codeforces" href="https://codeforces.com/" target="_blank" rel="noreferrer" >
                    ...
                    <a class="socialicon kaggle" href="https://www.kaggle.com/" target="_blank" rel="noreferrer" >
                        <FontAwesomeIcon icon={faKaggle} className='icons' />
                    </a>
                    <a class="socialicon instagram" href="https://www.instagram.com/" target="_blank" rel="noreferrer" >
                        <svg class="instagram-icon" x="0px" y="0px" viewBox="0 0 202.5 202.5" enableBackground="new 0 0 202.5 202.5">
                            ...
                            <path id="camera" class="st0" d="M79,60.5h44c10.5,0,19,8.5,19,19v44c0,10.5-8.5,19-19,19H79c-10.5,0-19-8.5-19-19v-44
                                                                                                        C60,69,68.5,60.5,79,60.5z"></path>
                        </svg>
                    </a>

                    <a class="socialicon github" href="https://github.com/" target="_blank" rel="noreferrer" >
