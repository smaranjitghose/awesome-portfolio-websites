...
const Reference = () => {
    return (
        <div>            
            ...
            <div className="" style={{width: "100%", minHeight: "80%;"}}>
                <div className="txt-bottom">
                    <div className="px-3">
                        <div className="row">
                            <div className="col-md-6 d-flex mt-5 flex-column text-center justify-content-center animate__animated animate__zoomIn animate__delay-1s">
                                <h2 className="main-heading mb-0 head-upper reference_head">
                                    My <span className="reference_work">References</span></h2>
                                <p className="pre-heading p-upper font-weight-bolder" className="mb-0 mt-3 text-center animate__animated animate__zoomIn animate__delay-2s">
                                I express my gratitude and love, as you have taken some minutes from your precious time to support my endeavors.
                                </p>
                            </div>

                            <div className="col-md-6" style={{marginTop: "-100px;"}}>
                                <div className="svg-animation-container">
                                    <svg id="f2557a61-56ef-4ee7-9811-4cdcc73688e4" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="1121.80595" height="550" viewBox="0 0 1121.80595 699.0818">
                                    <title>creative team</title>
                                    <circle cx="852.80585" cy="367.99943" r="253.9999" fill="#f2f2f2"/>
                                
                                    <circle cx="137.80597" cy="97.00003" r="97.00003" fill="#8A2BE2" className="circlemove"/>
                                    ...
                                    <g className="rectanglemove">
                                    <rect x="615.80595" y="433" width="320" height="190" fill="#3f3d56" className="rectanglework"/>                
                                    ...
                                    <path d="M990.403,588.9591s29,12,27,31,35,73,35,73,4,13,3,17,26,3,26,3v-9s-21-36-23-46-14-49-14-49-4-35-24-35A37.5,37.5,0,0,0,990.403,588.9591Z" transform="translate(-39.09703 -100.4591)" fill="#ffb9b9"/>
                            ...
                            ReferenceData.map((item => (
                                                <tr data-aos="zoom-in-left"> 
                                                    <td className="imgCol">
                                                    <img src={item ? item.image : "loading"} className="rImg" /></td>
                                                    <td class = "referenceTitleName">
                                                <div>
                                                    <span className="imgResponsive">
                                                    <img src="${image1}" className="imgRes" />
                                                    </span>
                                                </div>
                                                <img src="https://img.icons8.com/fluency/48/000000/quote-left.png"/>
                                                <a href="#0" className="paperTitle"> {item ? item.name : "loading"} </a> 
                                                <div> {item ? item.designation : "loading"} </div> <div className="rConferences">  
                                                <div className="referenceY">{item ? item.message : "loading"}</div>
                                                </div>  
                                                </td>
                                                </tr> 
                            )))
