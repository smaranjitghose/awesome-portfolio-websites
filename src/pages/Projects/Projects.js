...
import './Project.css';
import {projects} from './Cards/Allproj';
import Cardlist from './Cards/Cardlist';
import 'bootstrap/dist/css/bootstrap.min.css'
const Projects = () => {
    return (
        <>
        <div class=" container pt-5" style={{width: "100%" ,minHeight: "80%"}}>
        <section style={{height: "70vh"}}>
            <div class="px-3 pt-5">
                <div class="row">

                    <div class="col-md-6 godown">
                ...
                <g id="Man__x2F__chair__x2F__screen">
                  ...
                  <g id="Man_screen">
                    ...
                    <div class="dropdown col-md-6 d-flex mt-5 flex-column text-center justify-content-center">
                        <h2 class="main-heading mb-0 projects_head">My <span class="my_projects">Projects</span></h2>
                        <p className="pre-heading font-weight-bolder" class="mb-0 mt-3 text-center">
    ...
    <div class="conatiner" style={{padding:"20px"}}>
        <div class="page-content projectcards ">
