...
export default function Nav() {
  ...
  useEffect(() => setMounted(true), []);
    ...
    return (
        <div>
<header className="sticky-nav max-w-6xl w-full my-0 md:my-8 mx-auto  dark:bg-black bg-opacity-60 flex flex-wrap items-center">
  ...
  <div className="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
    <nav>
      <ul className="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
        <Link className="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="#">Features</Link>
      </ul>
    </nav>
  </div>
