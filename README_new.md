...
An open source project to create end-to-end templates for portfolio websites. We are a clan of geeks who want to provide you with that dope website that flaunts your hardwork and projects over the years to your mates and employers! With a deep desire to have that satiating UI, those engaging animations, the great SEO and an optimized code, we do it all. Hop in and start contributing if you wish to be a part of this amazing initiative.
...
<p align="center"><img width=50% src="https://media.giphy.com/media/l0IyjiXOXTX6Yemsg/giphy.gif"></p>
  ...
  **React/Next.Js can be used for development in another branch**
  ...
  - [ ] Splash Screen
  - [X] Navigation Bar ( Try to have a microanimation so that when we hover over one tab then a lamp enlights it)
  - [X] Footer
  - [X] Projects Page ( Cards + Appropriate Microanimation at top( like a furnace showing work in project)
    - [X] Image or Gif appropriate to the project
  ...
  - [ ] Education Page
    - [X] College Name, Duration, Courses, Activities
    - [X] Certifications 
  - [ ] Publications (Try to have it in an interactive Bibtex format)
...
Purpose of the Documentation is to ensure that anyone without any knowledge of web development can make use of this project template, modify its' content and host it successfully
...
<h2 align="center"><b>Open Source Programs we have been proudly a part of:</b></h2>
<p align="center">
